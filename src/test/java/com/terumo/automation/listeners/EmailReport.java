...
import com.terumo.automation.runner.TestRunner;
...
public class EmailReport {
	...
	public void EmailReport() throws IOException {
		...
		final String username = "techiebyte6120@gmail.com";
		final String password = "sapient@6120";
		...
		try {
			...
			message.setFrom(new InternetAddress("techiebyte6120@gmail.com"));
			...
			String file = "C:/Users/Arun Gupta/Documents/Reports/";
