...
import com.terumo.automation.listeners.JiraTicketLogger;
	...
	public void afterScenario(Scenario scenario) throws IOException {
		if (scenario.isFailed()) {
			...
			try {
				...
				screenshotFilePath = "C:/Users/Arun Gupta/Documents/Reports/Screenshots/"+screenshotName+"_"+configFileReader.getTimeStamp()+".png";
